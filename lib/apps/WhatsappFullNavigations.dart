...
class WhatsappFullNavigationsApp extends StatelessWidget {
...
class WhatsappSplashScreenBodyState extends State<WhatsappSplashScreenBody> {
  ...
  navigateToLoginRoute(BuildContext context){
    Navigator.pushReplacementNamed(
        context,
        WhatsappFullNavigationsApp.LOGIN_ROUTE
    );
  }
            ...
            //child: Icon(Icons.more_vert),
              ...
              onSelected: (selected) async {
                if(selected == "settings") {
                  Navigator.pushNamed(
                      context,
                      WhatsappFullNavigationsApp.SETTINGS_ROUTE
                  );
                }
                else if(selected == "new_group") {
                  Navigator.pushNamed(
                      context,
                      WhatsappFullNavigationsApp.NEW_GROUP_ROUTE
                  );
                }
