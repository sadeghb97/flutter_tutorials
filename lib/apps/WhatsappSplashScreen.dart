  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
        ...
        routes: {
          ...
          SPLASH_SCREEN_ROUTE: (context) => new SplashScreenBody(),
...
class SplashScreenBodyState extends State<SplashScreenBody> {
  ...
  void initState() {
    super.initState();
    Duration duration = new Duration(milliseconds: 3400);
    new Timer(duration, navigate);
  }

  void navigate() => Navigator.pushReplacement(
      context,
            ...
            //child: Icon(Icons.more_vert),
              ...
              onSelected: (selected){
                if(selected == "settings") {
                  Navigator.pushNamed(
                      context,
                      WhatsappSplashScreenApp.SETTINGS_ROUTE
                  );
                }
